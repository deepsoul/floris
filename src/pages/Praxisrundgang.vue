<template>
  <v-container class="my-12">
    <h1 class="text-h4 font-weight-bold mb-8 text-center">Praxisrundgang</h1>
    <v-row>
      <v-col cols="12" md="8">
        <v-card class="elevation-2 mb-6">
          <iframe
            ...
            width="100%"
            height="500px"
            src="https://ogulo.de/12076/EnddarmzentrumBietigheim"
            frameborder="0"
      ...
      <v-col cols="12" md="4">
        <v-card class="pa-6" elevation="2">
          <v-card-title class="font-weight-bold">
            <v-icon start color="primary">mdi-hospital-building</v-icon>
            Unsere Praxis
          </v-card-title>
