<template>
  <v-container class="py-8" style="max-width: 900px">
    <h1 class="text-h4 font-weight-bold mb-6">Datenschutzerklärung</h1>
    <v-card class="pa-4 mb-4" elevation="1">
      <v-card-text>
        <strong
          >Datenschutzerklärung für Websitebetreiber nach den Vorgaben der
          Datenschutzgrundverordnung (DSGVO)</strong
        >
      </v-card-text>
    </v-card>
    <v-expansion-panels multiple>
      <v-expansion-panel>
        <v-expansion-panel-title
          >I. Name und Anschrift des Verantwortlichen</v-expansion-panel-title
        >
        <v-expansion-panel-text>
          Enddarmzentrum Bietigheim<br />
          Bahnhofplatz 4<br />
          74321 Bietigheim-Bissingen<br />
          Telefon: 07432-53232<br />
          E-Mail: info@enddarmzentrum-bietigheim.de<br />
          Website: www.endddarmzentrum-bietigheim.de
        </v-expansion-panel-text>
      </v-expansion-panel>
      <v-expansion-panel>
        <v-expansion-panel-title
          >II. Optional: Name und Anschrift des
          Datenschutzbeauftragten</v-expansion-panel-title
        >
        <v-expansion-panel-text>
          Georgia Plastira<br />
          Enddarmzentrum Bietigheim<br />
          ...
          74321 Bietigheim-Bissingen<br />
          Telefon: 07432-53232<br />
          E-Mail: info@enddarmzentrum-bietigheim.de
        </v-expansion-panel-text>
      </v-expansion-panel>
      <v-expansion-panel>
        <v-expansion-panel-title
          >III. Allgemeines zur Datenverarbeitung</v-expansion-panel-title
        >
        <v-expansion-panel-text>
          ...
          a EU-Datenschutzgrundverordnung (DSGVO) als Rechtsgrundlage.<br /><br />
          ...
          Durchführung vorvertraglicher Maßnahmen erforderlich sind.<br /><br />
          Soweit eine Verarbeitung personenbezogener Daten zur Erfüllung einer
          rechtlichen Verpflichtung erforderlich ist, der unser Unternehmen
          unterliegt, dient Art. 6 Abs. 1 lit. c DSGVO als Rechtsgrundlage.<br /><br />
          ...
          d DSGVO als Rechtsgrundlage.<br /><br />
          ...
          Rechtsgrundlage für die Verarbeitung.<br /><br />
      ...
      <v-expansion-panel>
        <v-expansion-panel-title
          >IV. Kontaktformular und E-Mail-Kontakt</v-expansion-panel-title
        >
        <v-expansion-panel-text>
          ...
          sind:<br />
          E-Mail-Adresse des Nutzers<br /><br />
          ...
          übermittelten personenbezogenen Daten des Nutzers gespeichert.<br /><br />
          ...
          berechtigte Interesse an der Verarbeitung der Daten.<br /><br />
          ...
          informationstechnischen Systeme sicherzustellen.<br /><br />
          ...
          der betroffene Sachverhalt abschließend geklärt ist.<br /><br />
          Die während des Absendevorgangs zusätzlich erhobenen personenbezogenen
          Daten werden spätestens nach einer Frist von sieben Tagen gelöscht.<br /><br />
          ...
          solchen Fall kann die Konversation nicht fortgeführt werden.<br /><br />
      ...
      <v-expansion-panel>
        <v-expansion-panel-title
          >V. Rechte der betroffenen Person</v-expansion-panel-title
        >
        <v-expansion-panel-text>
          <p>
            Sie haben zahlreiche Rechte bezüglich Ihrer personenbezogenen Daten,
            darunter das Recht auf Auskunft, Berichtigung, Löschung,
            Einschränkung der Verarbeitung, Widerspruch, Datenübertragbarkeit,
            Widerruf der Einwilligung und Beschwerde bei einer Aufsichtsbehörde.
            Details entnehmen Sie bitte der vollständigen Datenschutzerklärung
            auf unserer Website oder wenden Sie sich direkt an uns.
          </p>
        </v-expansion-panel-text>
      </v-expansion-panel>
    </v-expansion-panels>
